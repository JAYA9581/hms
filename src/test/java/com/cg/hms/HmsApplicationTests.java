...
public void setTrainedInService(TrainedInServiceImpl trainedInService) {
    ...
    @Test
    void saveNurse() {
        Nurse nurse = new Nurse(1003,"sunaina","HeadNurse",true,120);
    ...
    void nurseSaveException() {
        ...
        @Test
        void savePhysician() {
            Physician physician = new Physician(1003,"praveen","engineer",200);
        ...
        void physicianByNameException() {
            ...
            @Test
            void saveProcedure() {
                Procedures procedure = new Procedures(1003,"surgery",100.0f);
